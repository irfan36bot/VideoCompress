...
async def help_message_f(client, message):
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('Updates Channel', url='https://t.me/DS_Botz')
                ],
                [
                    InlineKeyboardButton('Support Group', url='https://t.me/DSSupportGroup')
                ],
                [
                    InlineKeyboardButton('Developer', url='https://t.me/Irfan50786'), # Bloody Thief, Don't Become a Developer by Stealing other's Codes & Hard Works!
                    InlineKeyboardButton('Source Code', url='https://t.me/Irfan50786') # Must Give us Credits!
                ]
            ]
        ),
        quote=True
